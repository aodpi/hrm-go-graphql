...
func (ec *executionContext) _Query_tags(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNTag2ᚕᚖgithubᚗcomᚋaodpiᚋhrmᚑgoᚑgraphqlᚋv2ᚋgraphᚋmodelᚐTagᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalNTag2ᚕᚖgithubᚗcomᚋaodpiᚋhrmᚑgoᚑgraphqlᚋv2ᚋgraphᚋmodelᚐTagᚄ(ctx context.Context, sel ast.SelectionSet, v []*model.Tag) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNTag2ᚖgithubᚗcomᚋaodpiᚋhrmᚑgoᚑgraphqlᚋv2ᚋgraphᚋmodelᚐTag(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNTag2ᚖgithubᚗcomᚋaodpiᚋhrmᚑgoᚑgraphqlᚋv2ᚋgraphᚋmodelᚐTag(ctx context.Context, sel ast.SelectionSet, v *model.Tag) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "must not be null")
		}
